...
import {LocationStore} from './app/location/location.reducer';
...
class Application extends React.Component<ProviderProps & DispatchProp<any> & { locationReducer: LocationStore }, {}> {
    constructor(props: ProviderProps & DispatchProp<any> & { locationReducer: LocationStore }) {
        super(props);
    }
                    ...
                    <div className="body">
                        <Provider store={this.props.store}>
                            <switch>
                                ...
                                <Route exact path="/groups/:coffeeGroupId/add-saint"
                                       component={AddSaintComponent as any}/>
